...
public:
    ...
    QWidget *widget_bite_error;
    QPushButton *pushButton_playback;
    QLabel *label;
    QPushButton *pushButton_playback_2;
    QLabel *label_2;
    ...
    void setupUi(QWidget *Widget)
    {
        ...
        widget_bite_error = new QWidget(Widget);
        widget_bite_error->setObjectName("widget_bite_error");
        widget_bite_error->setGeometry(QRect(710, 100, 441, 271));
        ...
        pushButton_playback_2 = new QPushButton(Widget);
        pushButton_playback_2->setObjectName("pushButton_playback_2");
        pushButton_playback_2->setGeometry(QRect(420, 0, 81, 61));
        pushButton_playback_2->setFont(font);
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/new/prefix1/image/icons8-connect-250.png"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
        pushButton_playback_2->setIcon(icon6);
        pushButton_playback_2->setIconSize(QSize(24, 24));
        label_2 = new QLabel(Widget);
        label_2->setObjectName("label_2");
        label_2->setGeometry(QRect(430, 40, 91, 21));
    ...
    void retranslateUi(QWidget *Widget)
    {
        ...
        pushButton_playback_2->setText(QString());
        label_2->setText(QCoreApplication::translate("Widget", "\345\217\221\351\200\201\346\225\260\346\215\256\350\212\202\347\202\271", nullptr));
    } // retranslateUi
